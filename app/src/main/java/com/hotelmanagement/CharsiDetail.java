...
public class CharsiDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_charsi_detail);
        setTitle("Charsi Menu");

        listView = (ListView)findViewById(R.id.CharsiUserList);

        avgRatingBar = (RatingBar)findViewById(R.id.avgCharsiRatingBar);
        ...
        hotelNo = objDb.fetchRatingNo("4");
        ratingNo = objDb.fetchHotelNo("4");
    ...
    private void fillData() {
        cursor = objDb.fetchComments("4");
        customAdapter3 = new CustomAdapter3(CharsiDetail.this, cursor, 0);
