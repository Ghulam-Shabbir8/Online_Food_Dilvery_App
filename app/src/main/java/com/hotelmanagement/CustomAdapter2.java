...
public class CustomAdapter2 extends CursorAdapter {

    private LayoutInflater mInflater;

    @RequiresApi(api = Build.VERSION_CODES.HONEYCOMB)
    public CustomAdapter2(Context context, Cursor c, int flags) {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        holder.hotelName = (TextView) view.findViewById(R.id.srcHotelName);
        holder.hotelPrice = (TextView) view.findViewById(R.id.srcHotelPrice);
        holder.hotelQuantity = (TextView) view.findViewById(R.id.srcHotelQuant);
        holder.hotelImg = (ImageView) view.findViewById(R.id.srcHotelImg);
        holder.hotelRat = (RatingBar) view.findViewById(R.id.srcHotelRating);
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        holder.hotelPrice.setText("Price:"+cursor.getString(cursor.getColumnIndex(DbAdapter.KEY_ITEM_PRICE)));
