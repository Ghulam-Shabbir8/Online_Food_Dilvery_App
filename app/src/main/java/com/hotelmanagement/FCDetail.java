...
public class FCDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Fri Chicks Menu");

        listView = (ListView)findViewById(R.id.FCUserList);


        avgRatingBar = (RatingBar)findViewById(R.id.avgFCRatingBar);
        ...
        hotelNo = objDb.fetchRatingNo("3");
        ratingNo = objDb.fetchHotelNo("3");
    ...
    private void fillData() {
        cursor = objDb.fetchComments("3");
        customAdapter3 = new CustomAdapter3(FCDetail.this, cursor, 0);
