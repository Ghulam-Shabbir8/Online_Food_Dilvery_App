...
public class CustomAdapter3 extends CursorAdapter {

    private LayoutInflater mInflater;

    @RequiresApi(api = Build.VERSION_CODES.HONEYCOMB)
    public CustomAdapter3(Context context, Cursor c, int flags) {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        View view = mInflater.inflate(R.layout.row3, parent, false);
        ViewHolder holder = new ViewHolder();
        holder.hotelName = (TextView) view.findViewById(R.id.nameTxt);
        holder.hotelPrice = (TextView) view.findViewById(R.id.cmntsTxt);
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        holder.hotelPrice.setText(cursor.getString(cursor.getColumnIndex(DbAdapter.KEY_COMMENTS)));
